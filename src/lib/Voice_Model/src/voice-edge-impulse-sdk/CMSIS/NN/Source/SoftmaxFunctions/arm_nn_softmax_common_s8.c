...
#if VOICE_EI_CLASSIFIER_TFLITE_LOAD_CMSIS_NN_SOURCES
/*
...
#include "voice-edge-impulse-sdk/CMSIS/NN/Include/arm_nnsupportfunctions.h"
...
#endif // VOICE_EI_CLASSIFIER_TFLITE_LOAD_CMSIS_NN_SOURCES
