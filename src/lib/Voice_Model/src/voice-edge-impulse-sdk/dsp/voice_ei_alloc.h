 ...
 */
#ifndef __VOICE_EI_ALLOC__H__
#define __VOICE_EI_ALLOC__H__
...
struct EiAlloc
{
    ...
    T *allocate(size_t n)
    {
        ...
        auto ptr = voice_ei_dsp_malloc(bytes);
#if EIDSP_TRACK_ALLOCATIONS
    ...
    void deallocate(T *p, size_t n) noexcept
    {
        ...
        voice_ei_dsp_free(p,size_p->second);
        get_allocs().erase(size_p);
#else
        voice_ei_dsp_free(p,0);
#endif
    }
#if EIDSP_TRACK_ALLOCATIONS
    private:
