 ...
 */
#ifndef __VOICE_EI_DSP_HANDLE__H__
#define __VOICE_EI_DSP_HANDLE__H__
...
public:
    /**
     * @brief Override and call voice_ei_printf to print debug information, especially the current state
     *
     * @return int
     */
    virtual int print() = 0;
    ...
    virtual int extract(
        ...
        voice_ei_impulse_result_t *result) = 0; // result* is a hack.  I want to pass full context everywhere but custom DSP. TODO

    // Must declare so user can override
    /**
     * @brief If you call new or voice_ei_malloc anywhere in your class, you must override this function and delete your objects
     *
     */
    virtual ~DspHandle() {};
};

#endif //!__VOICE_EI_DSP_HANDLE__H__