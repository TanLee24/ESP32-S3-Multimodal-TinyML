...
#ifndef VOICE_EI_CEVA_DSP_H
#define VOICE_EI_CEVA_DSP_H
...
#if VOICE_EI_CLASSIFIER_HAS_FFT_INFO == 1  && !defined(VOICE_EI_CLASSIFIER_LOAD_ALL_FFTS)
// Intentionally empty
#else
#define VOICE_EI_LOAD_ALL_FFT_TABLES 1
#endif

    switch (log2_n_fft) {
#if VOICE_EI_LOAD_ALL_FFT_TABLES || VOICE_EI_CLASSIFIER_LOAD_FFT_32
        case 5: return twi_table_16_rfft_32;
#endif
#if VOICE_EI_LOAD_ALL_FFT_TABLES || VOICE_EI_CLASSIFIER_LOAD_FFT_64
        case 6: return twi_table_16_rfft_64;
#endif
#if VOICE_EI_LOAD_ALL_FFT_TABLES || VOICE_EI_CLASSIFIER_LOAD_FFT_128
        case 7: return twi_table_16_rfft_128;
#endif
#if VOICE_EI_LOAD_ALL_FFT_TABLES || VOICE_EI_CLASSIFIER_LOAD_FFT_256
        case 8: return twi_table_16_rfft_256;
#endif
#if VOICE_EI_LOAD_ALL_FFT_TABLES || VOICE_EI_CLASSIFIER_LOAD_FFT_512
        case 9: return twi_table_16_rfft_512;
#endif
#if VOICE_EI_LOAD_ALL_FFT_TABLES || VOICE_EI_CLASSIFIER_LOAD_FFT_1024
...
static int hw_r2c_fft(const float *input, ei::fft_complex_t *output, size_t n_fft)
{
    ...
    int16* temp = nullptr;
    auto ptr = VOICE_EI_MAKE_TRACKED_POINTER(temp, n_fft*2 + log2_n_fft*4);
//     auto ptr = VOICE_EI_MAKE_TRACKED_POINTER(temp, 1000);
    VOICE_EI_ERR_AND_RETURN_ON_NULL(temp, EIDSP_OUT_OF_MEM);

    float max_val = CEVA_DSP_LIB_FLOAT_VEC_MAX_ABS(const_cast<float*>(input), n_fft);
    // voice_ei_printf("max_val: %f\n", max_val);
    ...
    // for (size_t i = 0; i < n_fft; i++) {
    //     voice_ei_printf("%d,", ((int16*)output)[i]);
    // }
    // voice_ei_printf("\n");
