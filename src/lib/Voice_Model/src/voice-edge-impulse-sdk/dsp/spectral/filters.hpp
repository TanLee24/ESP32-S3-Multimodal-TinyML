...
namespace filters {
        ...
        size_t size)
    {
        ...
        float a2 = pow(a, 2);
        float *A = (float*)voice_ei_dsp_calloc(n_steps, sizeof(float));
        float *d1 = (float*)voice_ei_dsp_calloc(n_steps, sizeof(float));
        float *d2 = (float*)voice_ei_dsp_calloc(n_steps, sizeof(float));
        float *w0 = (float*)voice_ei_dsp_calloc(n_steps, sizeof(float));
        float *w1 = (float*)voice_ei_dsp_calloc(n_steps, sizeof(float));
        float *w2 = (float*)voice_ei_dsp_calloc(n_steps, sizeof(float));
        ...
        voice_ei_dsp_free(A, n_steps*sizeof(float));
        voice_ei_dsp_free(d1, n_steps*sizeof(float));
        voice_ei_dsp_free(d2, n_steps*sizeof(float));
        voice_ei_dsp_free(w0, n_steps*sizeof(float));
        voice_ei_dsp_free(w1, n_steps*sizeof(float));
        voice_ei_dsp_free(w2, n_steps*sizeof(float));
    }
