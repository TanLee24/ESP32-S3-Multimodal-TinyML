...
==============================================================================*/
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/pooling.h"
...
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/pooling.h"
...
#if VOICE_EI_TFLITE_DISABLE_AVERAGE_POOL_2D_IN_F32
...
#if VOICE_EI_TFLITE_DISABLE_AVERAGE_POOL_2D_IN_I8
      MicroPrintf("Type %s (%d) not supported.", TfLiteTypeGetName(input->type),
                  input->type);
      return kTfLiteError;
#endif
...
TfLiteStatus MaxEval(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (input->type == kTfLiteFloat32) {
#if VOICE_EI_TFLITE_DISABLE_MAX_POOL_2D_IN_F32
      MicroPrintf("Type %s (%d) not supported.", TfLiteTypeGetName(input->type),
                  input->type);
      return kTfLiteError;
#endif
...
#if VOICE_EI_TFLITE_DISABLE_MAX_POOL_2D_IN_I8
      MicroPrintf("Type %s (%d) not supported.", TfLiteTypeGetName(input->type),
                  input->type);
      return kTfLiteError;
#endif
...
#include "voice-edge-impulse-sdk/tensorflow/lite/c/builtin_op_data.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/integer_ops/pooling.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/tensor_ctypes.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/kernel_util.h"
