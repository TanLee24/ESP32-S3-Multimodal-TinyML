...
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/depthwise_conv.h"
...
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/depthwiseconv_float.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/integer_ops/depthwise_conv.h"
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (input->type) {  // Already know in/out types are same.
    case kTfLiteFloat32: {
#if VOICE_EI_TFLITE_DISABLE_DEPTHWISE_CONV_2D_IN_F32
    ...
    case kTfLiteInt8:
#if VOICE_EI_TFLITE_DISABLE_DEPTHWISE_CONV_2D_IN_I8
      MicroPrintf("Type %s (%d) not supported.", TfLiteTypeGetName(input->type),
                  input->type);
      return kTfLiteError;
#endif
...
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/quantization_util.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/depthwiseconv_float.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/depthwiseconv_uint8.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/tensor_ctypes.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/kernel_util.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/padding.h"
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (input->type) {  // Already know in/out types are same.
    ...
    case kTfLiteInt8:
      ...
      break;
    case kTfLiteUInt8:
#if VOICE_EI_TFLITE_DISABLE_DEPTHWISE_CONV_2D_IN_U8
      TF_LITE_KERNEL_LOG(context, "Type %s (%d) not supported.",
                      TfLiteTypeGetName(input->type), input->type);
      return kTfLiteError;
#endif
