...
==============================================================================*/
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/strided_slice.h"
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (output->type) {
    case kTfLiteFloat32:
      #if VOICE_EI_TFLITE_DISABLE_STRIDED_SLICE_OUT_F32
      ...
      break;
    case kTfLiteUInt8:
      #if VOICE_EI_TFLITE_DISABLE_STRIDED_SLICE_OUT_U8
      TF_LITE_KERNEL_LOG(context, "Type %s (%d) not supported.",
                      TfLiteTypeGetName(output->type), output->type);
      return kTfLiteError;
      #endif
      ...
      break;
    case kTfLiteInt8:
      #if VOICE_EI_TFLITE_DISABLE_STRIDED_SLICE_OUT_I8
      TF_LITE_KERNEL_LOG(context, "Type %s (%d) not supported.",
                      TfLiteTypeGetName(output->type), output->type);
      return kTfLiteError;
      #endif
      ...
      break;
    case kTfLiteInt16:
      #if VOICE_EI_TFLITE_DISABLE_STRIDED_SLICE_OUT_I16
      TF_LITE_KERNEL_LOG(context, "Type %s (%d) not supported.",
                      TfLiteTypeGetName(output->type), output->type);
      return kTfLiteError;
      #endif
      ...
      break;
    case kTfLiteInt32:
      #if VOICE_EI_TFLITE_DISABLE_STRIDED_SLICE_OUT_I32
      TF_LITE_KERNEL_LOG(context, "Type %s (%d) not supported.",
                      TfLiteTypeGetName(output->type), output->type);
      return kTfLiteError;
      #endif
      ...
      break;
    case kTfLiteBool:
      #if VOICE_EI_TFLITE_DISABLE_STRIDED_SLICE_OUT_BOOL
      TF_LITE_KERNEL_LOG(context, "Type %s (%d) not supported.",
                      TfLiteTypeGetName(output->type), output->type);
      return kTfLiteError;
      #endif
