...
#include "../../../../classifier/voice_ei_classifier_config.h"
#if 0 == 1
/* noop */
#elif VOICE_EI_CLASSIFIER_TFLITE_ENABLE_CMSIS_NN == 1
...
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/conv.h"

#include "voice-edge-impulse-sdk/CMSIS/NN/Include/arm_nn_types.h"
#include "voice-edge-impulse-sdk/CMSIS/NN/Include/arm_nnfunctions.h"
...
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/common.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/quantization_util.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/conv.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/reference/integer_ops/conv.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/tensor_ctypes.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/kernel_util.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/padding.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/kernel_util.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/micro_log.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/internal/portable_tensor_utils.h"
...
TfLiteStatus EvalQuantizedPerChannel(TfLiteContext* context, TfLiteNode* node,
  ...
  if (input_shape.Dims(3) != filter_shape.Dims(3)) {
#if !VOICE_EI_CMSIS_NN_CONV_REFERENCE_KERNEL_FALLBACK
    MicroPrintf("conv.cc: encountered input_shape with dims=[ %d, %d, %d, %d ] and filter_shape with dims=[ %d, %d, %d, %d ]. "
      "The CMSIS-NN kernel requires the last dimension to be the same. Set VOICE_EI_CMSIS_NN_CONV_REFERENCE_KERNEL_FALLBACK=1 "
    ...
    return kTfLiteOk;
#endif // !VOICE_EI_CMSIS_NN_CONV_REFERENCE_KERNEL_FALLBACK
  }
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (input->type) {  // Already know in/out types are same.
    case kTfLiteFloat32: {
#if VOICE_EI_TFLITE_DISABLE_CONV_2D_IN_F32
    ...
    case kTfLiteInt8:
#if VOICE_EI_TFLITE_DISABLE_CONV_2D_IN_I8
      MicroPrintf("Type %s (%d) not supported.", TfLiteTypeGetName(input->type),
                  input->type);
      return kTfLiteError;
#endif
...
#elif VOICE_EI_CLASSIFIER_TFLITE_ENABLE_ARC == 1
...
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/kernel_util.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/kernels/padding.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/mli_function_specializations.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/mli_slicers.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/mli_tf_utils.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/scratch_buf_mgr.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/scratch_buffers.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/kernels/kernel_util.h"
#include "voice-edge-impulse-sdk/tensorflow/lite/micro/micro_log.h"
...
#elif VOICE_EI_CLASSIFIER_TFLITE_ENABLE_SILABS_MVP == 1
...
#elif VOICE_EI_CLASSIFIER_TFLITE_ENABLE_ESP_NN == 1
...
#if ESP_NN
#include "voice-edge-impulse-sdk/porting/espressif/ESP-NN/include/esp_nn.h"
#endif
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (input->type) {  // Already know in/out types are same.
    ...
    case kTfLiteUInt8: {
#if VOICE_EI_TFLITE_DISABLE_CONV_2D_IN_U8
      TF_LITE_KERNEL_LOG(context, "Type %s (%d) not supported.",
                      TfLiteTypeGetName(input->type), input->type);
      return kTfLiteError;
#endif
